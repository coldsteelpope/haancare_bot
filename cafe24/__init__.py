...
shippedBeginListPageURL = "https://haancare1.cafe24.com/admin/php/shop1/s_new/shipped_begin_list.php"
shippedEndListPageURL = 'https://haancare1.cafe24.com/admin/php/shop1/s/shipped_end_list.php'
shippedStandByListOrdNumURL = "https://haancare1.cafe24.com/admin/php/shop1/s_new/shipped_standby_list_ord_num.php"
shippedCompleteListOrdNumURL = "https://haancare1.cafe24.com/admin/php/shop1/s_new/shipped_complete_list_ord_num.php"
...
def LoginCafe24(driver):
    ...
    try:
        ...
        pass
    driver.find_element(By.XPATH, '//*[@id="mall_id"]').send_keys(id)
    driver.find_element(By.XPATH, '//*[@id="userpasswd"]').send_keys(pw)
